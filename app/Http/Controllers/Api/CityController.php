...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $record = City::updateOrCreate($request->except('_method', '_token'));

        return JsonResponse(200, getMessage('City', 'create', 'success'));
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        return JsonResponse(200, getMessage('City', 'update', 'success'));
    }
}
